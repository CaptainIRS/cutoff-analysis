...
@push('title', 'Analyse Round-wise Cut-off Trends |')
...
@section('meta')
    ...
    <meta property="og:title" content="Analyse Round-wise Cut-off Trends - JoSAA Analysis">
    <meta property="og:description"
        content="Compare the cut-offs of a course in various rounds over 10 years in the JoSAA seat allocation process.">
    <meta property="og:url" content="{{ route('round-trends') }}">
    <meta property="og:type" content="website">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="Analyse Round-wise Cut-off Trends - JoSAA Analysis">
