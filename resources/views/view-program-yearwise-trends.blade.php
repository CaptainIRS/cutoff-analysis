@props(['rank', 'institutes', 'courses', 'programs', 'hide_controls'])
@extends('layouts.app')
...
@section('content')
    <livewire:institute-trends-proxy :rank_type="$rank" :institutes="$institutes" :courses="$courses" :programs="$programs"
