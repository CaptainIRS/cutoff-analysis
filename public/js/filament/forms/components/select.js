                                ...
                                function g(e, t) {
                                    ...
                                    if (
                                        ...
                                        (this._isSelectOneElement =
                                            _.type === y.SELECT_ONE_TYPE),
                                        (this._isSelectMultipleElement =
                                            _.type === y.SELECT_MULTIPLE_TYPE),
                                        ...
                                        function (e, t, n) {
                                            ...
                                            return (
                                                ...
                                                e.forEach(function (P) {
                                                    var M = _(P);
                                                    if (M.length >= 1) {
                                                        var K = o._getTemplate(
                                                            "choiceGroup",
                                                            P
                                                        );
                                                        n.appendChild(K),
                                                            o._createChoicesFragment(
                                                                M,
                                                                n,
                                                                !0
                                                            );
                    ...
                    221: function (j, i, b) {
                        ...
                        class V {
                            ...
                            removeAt(s) {
                                ...
                                for (let m = s, S = this.size(); m < S; m += 1)
                                    this.records[m].i -= 1;
                            }
                        ...
                        class Be extends le {
                            ...
                            search(s) {
                                ...
                                for (; (S = s.indexOf(this.pattern, m)) > -1; )
                                    (m = S + T), I.push([S, m - 1]);
                                let A = !!I.length;
                                return {
                                    isMatch: A,
                        ...
                        function nt(
                            p,
                            { ignoreFieldNorm: s = u.ignoreFieldNorm }
                        ) {
                            p.forEach((m) => {
                                let S = 1;
                                m.matches.forEach(
                        ...
                        class Se {
                            ...
                            setCollection(s, m) {
                                if (((this._docs = s), m && !(m instanceof V)))
                                    throw new Error(Z);
                                this._myIndex =
                                    m ||
                            ...
                            add(s) {
                                y(s) &&
                                    (this._docs.push(s), this._myIndex.add(s));
                            }
                            remove(s = () => !1) {
                                let m = [];
                                for (
                            ...
                            removeAt(s) {
                                this._docs.splice(s, 1),
                                    this._myIndex.removeAt(s);
                            }
                            getIndex() {
        ...
        getExistingOptions: async function ({
            ...
            return (
                e !== "" && e !== null && e !== void 0
                    ...
                    : (n = await j()),
                n.map((o) =>
                    Array.isArray(this.state) && this.state.includes(o.value)
                        ? ((_) => ((_.selected = !0), _))(o)
                        : o
                )
            );
        ...
        getMissingOptions: async function (e) {
            ...
            return v
                ? t.every((o) => n.has(o))
                    ? {}
                    : (await me())
                          .filter((o) => !n.has(o.value))
                          .map((o) => ((o.selected = !0), o))
                : n.has(t)
                ? n
