...
var h = !1,
    ...
    p = class {
        ...
        set dragging(t) {
            ...
            r(h ? "touchmove" : "mousemove", this),
                r(h ? "touchend" : "mouseup", this);
        }
        handleEvent(t) {
            switch (t.type) {
                case "mousedown":
                case "touchstart":
                    if ((t.preventDefault(), !ut(t) || (!h && t.button != 0)))
                        return;
...
var S = Symbol("same"),
    ...
    c = class extends HTMLElement {
        ...
        handleEvent(t) {
            ...
            let o;
            !I(s, r) &&
                !this[S]((o = this.colorModel.fromHsva(s))) &&
                this[R](o);
        }
        [S](t) {
...
function xt({
    ...
    return {
        ...
        setState: function (o) {
            (this.state = o),
                (this.$refs.input.value = o),
                (this.$refs.panel.color = o);
        },
        isOpen: function () {
