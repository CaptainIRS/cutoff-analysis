    ...
    if ((t && typeof t == "object") || typeof t == "function")
        for (let e of ei(t))
            !ni.call(n, e) &&
                ...
                Vt(n, e, {
                    get: () => t[e],
                    enumerable: !(i = Qn(t, e)) || i.enumerable,
                });
    return n;
};
var _e = (n, t, r) => (
    ...
    ii(
        t || !n || !n.__esModule
            ? Vt(r, "default", { value: n, enumerable: !0 })
            : r,
        n
    )
);
    ...
    (function (n, t) {
        ...
        return function (o, c, D) {
            (D.p.customParseFormat = !0),
                o && o.parseTwoDigitYear && (s = o.parseTwoDigitYear);
            var p = c.prototype,
                k = p.parse;
            p.parse = function (T) {
                var S = T.date,
                ...
                d = function () {
                    ...
                    return {
                        ...
                        weekdaysMin: function (f) {
                            return f
                                ? f.format("dd")
                                : u(_, "weekdaysMin", "weekdays", 2);
                        },
                        weekdaysShort: function (f) {
                            return f
                                ? f.format("ddd")
                                : u(_, "weekdaysShort", "weekdays", 3);
                        },
            ...
            (d.tz = function (f, y) {
                ...
                var l = this.utcOffset(),
                    ...
                    p = e(c)
                        ...
                        .utcOffset(
                            15 * -Math.round(o.getTimezoneOffset() / 15) - D,
                            !0
                        );
                if (y) {
                    var k = p.utcOffset();
                ...
                (d.offsetName = function (f) {
                    var y = this.$x.$timezone || e.tz.guess(),
                        l = s(this.valueOf(), y, { timeZoneName: f }).find(
                            function (o) {
        ...
        var r = t(n),
            i = {
                ...
                relativeTime: {
                    ...
                    s: function (e, u, s, a) {
                        return (
                            "n\xE9h\xE1ny m\xE1sodperc" + (a || u ? "" : "e")
                        );
                    },
                    m: function (e, u, s, a) {
...
var Le = function (t, r, i) {
    ...
    an = { s: Le, z: si, m: ai, a: ui, p: oi, u: di };
var de = "en",
    ae = {};
ae[de] = sn;
var ve = function (t) {
        ...
        return (
            ...
            (t.startOf = function (i, e) {
                var u = this,
                    ...
                    d = function (k, T) {
                        var S = z.w(
                            u.$u ? Date.UTC(u.$y, T, k) : new Date(u.$y, T, k),
                            u
                        );
                    ...
                    _ = function (k, T) {
                        ...
                        return z.w(
                            u
                                .toDate()
                                [k].apply(u.toDate("s"), (s ? S : C).slice(T)),
                            u
                        );
                    },
                    f = this.$W,
            ...
            (t.format = function (i) {
                ...
                return s.replace(nn, function (T, S) {
...
function li({
    ...
    return {
        ...
        init: function () {
            ...
            let a =
                this.getSelectedDate() ?? A().tz(s).hour(0).minute(0).second(0);
            ((this.getMaxDate() !== null && a.isAfter(this.getMaxDate())) ||
                ...
                this.$watch("focusedYear", () => {
                    ...
                    Number.isInteger(d) ||
                        ((d = A().tz(s).year()), (this.focusedYear = d)),
            ...
            return !!(
                (this.$refs?.disabledDates &&
                    JSON.parse(this.$refs.disabledDates.value ?? []).some(
                        (d) => (
                            (d = A(d)), d.isValid() ? d.isSame(a, "day") : !1
                        )
                    )) ||
        ...
        togglePanelVisibility: function () {
            this.isOpen() ||
                ((this.focusedDate =
                    this.getSelectedDate() ?? this.getMinDate() ?? A().tz(s)),
                this.setupDaysGrid()),
