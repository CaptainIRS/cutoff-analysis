(() => {
        ...
        let t = ur(e),
            r =
                ["absolute", "fixed"].includes(Hn(e).position) && Et(e)
                    ...
                    : e;
        return Gt(r)
            ? t.filter((o) => Gt(o) && $i(o, r) && _t(o) !== "body")
            : [];
    }
    function Ui(e) {
    ...
    var To = (e, t, n) => Si(e, t, { platform: Xi, ...n }),
        zi = (e) => {
            ...
            return (
                ...
                n.includes("shift") && t.middleware.push(Fo(r("shift"))),
                ...
                n.includes("size") && t.middleware.push(Bo(r("size"))),
                t
            );
        },
        Yi = (e, t) => {
            ...
            return (
                ...
                e.includes("shift") && n.float.middleware.push(Fo(t.shift)),
                ...
                e.includes("size") && n.float.middleware.push(Bo(t.size)),
                n
            );
        },
        qi = (e) => {
    ...
    var Jr = new MutationObserver(Yo),
        Qr = !1;
    function Zi() {
        Jr.observe(document, {
            subtree: !0,
    ...
    function Yo(e) {
        ...
        for (let i of n)
            if (!t.includes(i) && (Ki.forEach((s) => s(i)), i._x_cleanups))
    ...
    var D,
        ...
        wa = Dr && !ai && !ii && "draggable" in document.createElement("div"),
        di = (function () {
            if (Dr) {
                if (Lt) return !1;
                ...
                if (
                    ...
                    (u = function () {
                        ...
                        o._disableDelayedDragEvents(),
                            !Jo && o.nativeDraggable && (D.draggable = !0),
